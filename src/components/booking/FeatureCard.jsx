const FeatureCard = ({ icon: Icon, title, description }) => (
  <div className="group bg-primary-gray2 border border-primary-gray2 flex items-center justify-center flex-col p-8 rounded-[2rem] hover:bg-white/[0.04] transition-all hover:border-moss-green/20">
