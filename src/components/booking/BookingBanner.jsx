...
export const BookingBanner = () => {
  return (
    <div className="border-2 border-primary-gray2 rounded-2xl p-4 md:px-12 md:mb-6 md:mb-8 flex flex-col md:flex-row items-center justify-between gap-8">
      ...
      {/* Make Link the button directly */}
      <Link
        href={`tel:+${phone}`}
        title="Call Now"
        className="w-full md:w-auto bg-primary-gray2 text-white px-5 py-3 md:py-5 rounded-xl font-black text-sm md:text-base hover:bg-earth-brown-light transition-transform active:scale-95 flex items-center justify-center gap-2"
      >
        <svg
          className="w-5 h-5"
          fill="none"
