  ...
  return (
    <div className="px-6">
      <section className="pb-12  flex items-center justify-center flex-col">
        ...
        <div className="relative max-w-7xl overflow-hidden w-full h-[500px] rounded-xl  bg-earth-brown shadow-md ">
          {/* <div
        ...
        <div className="absolute bottom-6 left-6 right-6 flex flex-wrap gap-4">
          <div className="bg-background-dark/80 backdrop-blur-md px-4 py-3 rounded-lg flex items-center gap-3 border border-earth-brown">
