...
const GallerySchema = {
  ...
  "description": "Explore the eco gallery of Madhuban Eco Retreat, showcasing nature, tribal culture, forest views, heritage sites and scenic experiences from Ratapani.",
  "mainEntity": {
    "@type": "ImageGallery",
    "name": "Eco Gallery",
    "image": [
...
export const metadata = {
  title:
    "Madhuban Eco Gallery | Nature, Culture & Retreat Photo Collection",
